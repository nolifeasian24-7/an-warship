...
client.on('ready', ()=> {
	...
	client.user.setPresence({
		status: 'idle',
		activity: {
			name: "jesser where is the methe",
			type: 'STREAMING'
		}
	})
});
...
client.on('message', async message =>{
	...
	else if (command === 'help')
	{
		...
		.setImage('https://tenor.com/view/big-chungus-me-when-the-how-is-this-man-this-will-be-graphics-in2013-when-the-gif-17486646')
		.addFields(
			{
				name: "moderation",
...
client.login('NzU2MjYzMDc1MDEwNTc2NDU2.X2PS3w.m2iDdiYc9-Yhhs_mUr0KNZnP2gg');