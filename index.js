...
client.on('message', async message =>{
	...
	else if (command === 'user-info')
	{
		...
		.addField(`Your status is currently set you: ${message.author.presence}`)
		.addField(`And you joined ${message.author.guild} on ${message.author.join}`)
...
client.login('NzU2MjYzMDc1MDEwNTc2NDU2.X2PS3w.6IEcMVuAyO_CtCcjBdALAS3Gr1M');