...
client.on('message', async message =>{
	...
	else if (command === 'user-info')
	{
		...
		.addFields(
			{name: 'your status is currently set to:', value: `${message.author.presence.status}`, inline: true},
			{name: `and you joined ${message.guild.name}:`, value: `on: ${message.guild.joinedAt}`, inline: true},
		)
